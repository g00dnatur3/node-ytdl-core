  ...
  if (format.isHLS || format.isDashMPD) {
    ...
    if (shouldBeChunked) {
      ...
      const getNextChunk = () => {
        ...
        console.log()
        console.log('GOT HERE 1 - format.url:', format.url)
        console.log()

        requestOptions.url = format.url

        req = tr.request(requestOptions)
