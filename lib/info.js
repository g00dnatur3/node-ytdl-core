...
const getHTMLWatchPageBody = async (id, options) => {

  console.log('GOT HERE - getHTMLWatchPageBody')
...
const getWatchJSONPage = async(id, options) => {
  ...
  console.log('GOT HERE - getWatchJSONPage')
  ...
  const getInfo = async () => {
    ...
    const {req, res, body} = await doGet(jsonUrl, reqOptions)
    // console.log()
    // console.log('body:\n', body)
    // console.log()
...
const getVideoInfoPage = async(id, options) => {
  ...
  console.log('GOT HERE - getVideoInfoPage')
...
const getDashManifest = (url, options) => new Promise((resolve, reject) => {
  ...
  console.log('GOT HERE - getDashManifest')
  ...
  const _url = urllib.resolve(VIDEO_URL, url).href
  ...
  //     tr.request(reqOptions, async (err, res, body) => {
